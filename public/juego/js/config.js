...
const levels = [
    ...
    { target: 4200, moves: 32, iceCount: 4, iceHits: 1, objectives: [{ type: "ice", count: 4, hits: 1 }] },
    { target: 4200, moves: 32, iceCount: 5, iceHits: 1, objectives: [{ type: "ice", count: 5, hits: 1 }] },
    { target: 4500, moves: 31, iceCount: 6, iceHits: 1, objectives: [{ type: "ice", count: 6, hits: 1 }] },
    { target: 4500, moves: 31, iceCount: 7, iceHits: 1, objectives: [
        { type: "ice", count: 7, hits: 1 }, { type: "special", count: 1 }
    ] },
    { target: 4500, moves: 38, iceCount: 8, iceHits: 1, objectives: [
        { type: "ice", count: 8, hits: 1 }, { type: "rainbow", count: 1 }
    ] },
    { target: 4500, moves: 35, iceCount: 9, iceHits: 1, objectives: [
        { type: "ice", count: 9, hits: 1 }, { type: "clear", piece: 1, count: 10 }
    ] },
    { target: 4600, moves: 40, iceCount: 10, iceHits: 1, objectives: [
        { type: "ice", count: 10, hits: 1 }, { type: "special", count: 2 }
    ] },
    { target: 4600, moves: 38, iceCount: 11, iceHits: 1, objectives: [
        { type: "ice", count: 11, hits: 1 }, { type: "clear", piece: 0, count: 12 }
    ] },
    { target: 4700, moves: 39, iceCount: 12, iceHits: 1, objectives: [
        { type: "ice", count: 12, hits: 1 }, { type: "rainbow", count: 1 }, { type: "special", count: 1 }
    ] },
    { target: 4900, moves: 40, iceCount: 14, iceHits: 1, objectives: [
        { type: "ice", count: 14, hits: 1 }, { type: "clear", piece: 1, count: 12 }
    ] },

    // 31-40: hielo de 2 capas + cajas
    { target: 5000, moves: 32, iceCount: 6, iceHits: 2, objectives: [
        { type: "ice", count: 6, hits: 2 }, { type: "box", count: 6, hits: 1 }
    ] },
    { target: 5100, moves: 32, iceCount: 7, iceHits: 2, objectives: [
        { type: "ice", count: 7, hits: 2 }, { type: "box", count: 7, hits: 1 }
    ] },
    { target: 5100, moves: 35, iceCount: 8, iceHits: 2, objectives: [
        { type: "ice", count: 8, hits: 2 }, { type: "box", count: 8, hits: 1 }
    ] },
    { target: 5200, moves: 38, iceCount: 9, iceHits: 2, objectives: [
        { type: "ice", count: 9, hits: 2 }, { type: "box", count: 8, hits: 2 }
    ] },
    { target: 5300, moves: 40, iceCount: 10, iceHits: 2, objectives: [
        { type: "ice", count: 10, hits: 2 }, { type: "box", count: 10, hits: 2 }, { type: "special", count: 1 }
    ] },
    { target: 5400, moves: 39, iceCount: 11, iceHits: 2, objectives: [
        { type: "ice", count: 11, hits: 2 }, { type: "box", count: 10, hits: 2 }, { type: "rainbow", count: 1 }
    ] },
    { target: 5800, moves: 45, iceCount: 12, iceHits: 2, objectives: [
        { type: "ice", count: 12, hits: 2 }, { type: "box", count: 12, hits: 2 }
    ] },
    { target: 5200, moves: 39, iceCount: 13, iceHits: 2, objectives: [
        { type: "ice", count: 13, hits: 2 }, { type: "box", count: 12, hits: 2 }, { type: "special", count: 2 }
    ] },
    { target: 5800, moves: 38, iceCount: 14, iceHits: 2, objectives: [
        { type: "ice", count: 14, hits: 2 }, { type: "box", count: 14, hits: 2 }, { type: "rainbow", count: 1 }
    ] },
    { target: 5500, moves: 40, iceCount: 15, iceHits: 2, objectives: [
